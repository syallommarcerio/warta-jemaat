    ...
    <a
        href="{{ route('login') }}"
        class="hidden md:flex items-center justify-center px-md py-xs rounded-full bg-primary text-on-primary font-label-md text-label-md hover:bg-primary/90 transition-colors shadow-sm hover:shadow-md active:scale-95 transition-transform"
    >
        Login Admin
    </a>
